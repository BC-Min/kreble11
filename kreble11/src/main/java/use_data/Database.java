...
public class Database {
	...
	public void join_member_succass(UserData ud) throws Exception {
		try{
			conn();
			String command = String.format("insert into user values('"+ud.getId()+"','"+ud.getId()+"' ,'"+ud.getName()+"','"+ud.getPw()+"','"+ud.getPh()+"','"+ud.getEmail()+"','"+ud.getAddress()+"',now(), now(),'"+ud.getGender()+"',default);");
